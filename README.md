...
[![BLOC Wallet iOS app in details - Download the app store](https://wiki.bloc.money/wallets/images/iOS-wallet/BLOC-IOS-WALLET-APP-VIDEO-GUIDE.jpg)](https://www.youtube.com/watch?v=lrYZXrH5D58)

Fast Payment Processing using the QRCODE feature

[![Fast Payment Processing using the QRCODE feature](https://wiki.bloc.money/wallets/images/iOS-wallet/BLOC-IOS-WALLET-QRCODE-VIDEO-GUIDE.jpg)](https://www.youtube.com/watch?v=w228SRqSJBY)

How to mine using the BLOC Wallet for iOS

[![How to mine using the BLOC Wallet for iOS](https://wiki.bloc.money/wallets/images/iOS-wallet/BLOC-IOS-WALLET-MINING-VIDEO-GUIDE.jpg)](https://www.youtube.com/watch?v=4dYKJW3olOk)

How to build the open source BLOC iOS Wallet app with Xcode

[![How to build the open source BLOC iOS Wallet app with Xcode](https://wiki.bloc.money/wallets/images/iOS-wallet/BLOC-IOS-WALLET-XCODE-VIDEO-GUIDE.jpg)](https://www.youtube.com/watch?v=Ve2GGJ-UIxE)
